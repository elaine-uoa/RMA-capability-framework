  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      {nextCapability ? (
        ...
        <Link
          href="/plan"
          className="bg-[#00457D] text-white rounded-lg p-5 hover:bg-[#003561] transition-all duration-200 md:col-start-2"
        >
          <div className="flex items-center gap-4">
            <div className="flex-1 min-w-0 text-right">
              <div className="text-xs font-semibold text-white/70 uppercase tracking-wider mb-1">Next Step</div>
